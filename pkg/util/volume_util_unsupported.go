...
func (u *volumeUtil) GetFsCapacityByte(hostDir, mountDir, file string, mountPointMap map[string]interface{}) (int64, error) {
...
func (u *volumeUtil) IsLikelyMountPoint(hostDir, mountDir, file string) (bool, error) {
